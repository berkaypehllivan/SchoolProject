...
public class SetFloatBehaviour : StateMachineBehaviour
{
    ...
    // OnStateMachineEnter is called when a transition starts and the state machine starts to evaluate this state
    ...
    // OnStateMachineExit is called when a transition starts and the state machine starts to evaluate this state
